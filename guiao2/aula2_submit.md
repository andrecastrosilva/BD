...
Atributos:
• Produto – código, nome, preço, taxa de IVA;
• Encomenda - número de encomenda, data;
• Fornecedor - nome, NIF, endereço, número de fax, condições de pagamento;
•  Tipo de forncedor - código interno do tipo de fornecedor, designação.

Relações:
• Um produto pode estar presente em várias encomendas (relação N:M entre Produto e Encomenda através da entidade Item de Encomenda);
• Um fornecedor pode estar associado a várias encomendas (relação 1:N entre Fornecedor e Encomenda).
• Um tipo de fornecedor pode estar presente em  a vários fornecedores (relação N:M entre tipo de fornecedor e Fornecedor).
...
```
Encomenda - Produto
• Grau: 2 (duas entidades envolvidas na relação)
• Cardinalidade: relação M:N.
• Obrigatoriedade: Obrigatoriedade de participação na relação da entidade Encomenda.

Fornecedor – Encomenda
• Grau: 2 (duas entidades envolvidas na relação)
• Cardinalidade: Relação 1:N.
• Obrigatoriedade: Obrigatoriedade de participação na relação da entidade Encomenda.

Fornecedor – Tipo de fornecedor
• Grau: 2 (duas entidades envolvidas na relação)
• Cardinalidade: Relação M:N.
• Obrigatoriedade: Obrigatoriedade de participação na relação da entidade Fornecedor.
```
